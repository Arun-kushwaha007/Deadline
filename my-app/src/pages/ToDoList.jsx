          ...
          <div className="bg-card rounded-2xl shadow-lg border border-border p-6 mb-8">
            ...
            <div className="flex flex-col sm:flex-row gap-3">
              <input
                ...
                className="flex-1 px-4 py-3 border border-slate-300 dark:border-border rounded-lg bg-white dark:bg-accent text-foreground placeholder-slate-500 dark:placeholder-muted-foreground focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
              />
              <button
                onClick={addTask}
                disabled={!task.trim()}
                    ...
                    <button
                      ...
                      className={`px-3 py-1 rounded-full text-sm font-medium transition-colors ${
                        filter === filterType
                          ...
                          : 'bg-accent text-muted-foreground hover:bg-slate-200 dark:hover:bg-slate-600'
                      }`}
                    >
