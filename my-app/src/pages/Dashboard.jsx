  ...
  return (
    <DashboardLayout>
      <div className="min-h-screen bg-gray-50 dark:bg-zinc-900 transition-colors duration-300">
        ...
        <div className="bg-gradient-to-b from-blue-50 to-purple-50 dark:from-zinc-950 dark:to-zinc-900 mb-4 sm:mb-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
            <div className="text-center">
              {/* Greeting and Time */}
              <div className="mb-1">
                <h1 className="text-xl sm:text-2xl md:text-3xl font-bold bg-gradient-to-r from-blue-600 via-purple-600 to-orange-500 bg-clip-text text-transparent mb-2">
                  {getGreeting()}, {user.name || 'User'}!
                </h1>
                <div className="flex flex-col sm:flex-row items-center justify-center gap-2 sm:gap-4 text-gray-600 dark:text-gray-400">
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg">📅</span>
                    <span className="text-sm sm:text-lg font-medium">{formatDate(currentTime)}</span>
                  </div>
                  <div className="hidden sm:block w-2 h-2 bg-gray-400 rounded-full"></div>
                  <div className="flex items-center gap-2">
                    <span className="text-base sm:text-lg">⏰</span>
                    <span className="text-sm sm:text-lg font-mono">{formatTime(currentTime)}</span>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6">
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 dark:from-green-900/20 dark:to-green-800/20 rounded-xl p-4 sm:p-6 border border-green-200 dark:border-green-800">
              <div className="flex items-center gap-2 sm:gap-3">
                ...
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Active Tasks</p>
                  <p className="text-lg sm:text-2xl font-bold text-gray-800 dark:text-white">12</p>
                </div>
              </div>
            </div>

            <div className="bg-gradient-to-br from-orange-50 to-orange-100 dark:from-orange-900/20 dark:to-orange-800/20 rounded-xl p-4 sm:p-6 border border-orange-200 dark:border-orange-800">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-orange-500 rounded-full flex items-center justify-center text-white text-sm sm:text-xl">
                  ⏰
                </div>
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Due Today</p>
                  <p className="text-lg sm:text-2xl font-bold text-gray-800 dark:text-white">3</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-xl p-4 sm:p-6 border border-purple-200 dark:border-purple-800">
              <div className="flex items-center gap-2 sm:gap-3">
                <div className="w-8 h-8 sm:w-12 sm:h-12 bg-purple-500 rounded-full flex items-center justify-center text-white text-sm sm:text-xl">
                  📈
                </div>
                <div>
                  <p className="text-xs sm:text-sm text-gray-600 dark:text-gray-400">Completed</p>
                  <p className="text-lg sm:text-2xl font-bold text-gray-800 dark:text-white">28</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-4 sm:space-y-8 pb-4 sm:pb-8">
          ...
          {/* Kanban Section */}
          <div className="bg-white dark:bg-zinc-900 rounded-xl sm:rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div className="bg-gradient-to-r from-green-500 to-teal-600 p-4 sm:p-6">
              <h3 className="text-xl sm:text-2xl font-bold text-white flex items-center gap-2 sm:gap-3">
                <span className="text-base sm:text-xl">📋</span>
                Task Board
              </h3>
